...
//! ```rust,no_run
//! use bevy::prelude::*;
//! use eventwork_sync::control::{ExclusiveControlPlugin, EntityControl, ExclusiveControlConfig, AppExclusiveControlExt};
...
/// ```rust,no_run
/// use bevy::prelude::*;
/// use eventwork_sync::control::{ExclusiveControlPlugin, EntityControl, AppExclusiveControlExt};
/// use eventwork_websockets::WebSocketProvider;
///
/// fn main() {
///     App::new()
...
use eventwork::{Network, NetworkData};
