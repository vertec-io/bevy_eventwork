...
- [Getting Started: eventwork_sync](../getting-started/eventwork-sync.md) - Server setup
- [Getting Started: eventwork_client](../getting-started/eventwork-client.md) - Client setup
