...
> 📚 **Advanced:** Eventwork also supports `OutboundMessage` with `MessageWriter` for precise control over network scheduling. See **[SENDING_MESSAGES.md](./SENDING_MESSAGES.md)** for the complete guide on both approaches.
